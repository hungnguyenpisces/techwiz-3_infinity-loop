!function (n) {
    ...
    function pt(n) {
        var t, e, a, r, o, i = (u = n.oScroll).sX, l = u.sXInner, s = u.sY, u = u.iBarWidth, c = P(n.nScrollHead),
            ...
            b = p.style, m = P(n.nScrollFoot).children("div"), S = m.children("table"), v = P(n.nTHead),
            D = P(n.nTable), y = D[0], _ = y.style, T = n.nTFoot ? P(n.nTFoot) : null, w = n.oBrowser,
            C = w.bScrollOversize, x = re(n.aoColumns, "nTh"), I = [], A = [], F = [], L = [], R = function (t) {
