        ...
        return this.each(function () {
            ...
            var methods = {
                init: function () {
                    ...
                    elem.addClass(elemClass + "_container")
                        .attr("data-waitme_id", currentID)
                        .append(waitMeObj);
                    elemObj = elem.find("> ." + elemClass);
                    var elemContentObj = elem.find(
                        "." + elemClass + "_content"
                    );
                    ...
                    if (_options.maxSize !== "") {
                        ...
                        if (_options.effect === "img") {
                            ...
                            elemContentObj.css({
                                marginTop:
                                    -elemContentObj.outerHeight() / 2 + "px",
                            });
                        } else {
                    ...
                    function setElTop(getTop) {
                        elemContentObj.css({
                            top: "auto",
                            transform:
                                "translateY(" + getTop + "px) translateZ(0)",
                        });
                    }
            ...
            function waitMeClose() {
                ...
                elem.removeClass(elemClass + "_container").removeAttr(
                    "data-waitme_id"
                );
                elem.find(
                    "." + elemClass + '[data-waitme_id="' + currentID + '"]'
                ).remove();
            }
            if (methods[method]) {
