            ...
            <form method="POST" action="{{route('permissions.store')}}" id="permissionForm">
                ...
                <div class="modal-body">
                    <div class="input-group flex-nowrap">
                        ...
                        <input type="text" class="form-control border border-success" name="name" placeholder="exam-permission" aria-label="permission" aria-describedby="addon-wrapping" required>
                        @error('name')
