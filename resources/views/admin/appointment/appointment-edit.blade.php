                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" placeholder="First Name"
                                                       value="{{$appointment->user->first_name}}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" placeholder="Last Name"
                                                       value="{{$appointment->user->last_name}}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                <textarea rows="4" name="staff_note" class="form-control no-resize"
                                                          placeholder="Please type what you want...">{{$appointment->staff_note}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <a href="{{route('all-appointment.index')}}"
                                               class="btn btn-primary waves-effect">Back to list</a>
                                            <button type="submit" class="btn-secondary" onclick={window.location.href="{{route('appointmentmanage.update',501)}}"} >update</button>
{{--                                            <button type="submit" class="btn btn-raised bg-deep-purple"--}}
{{--                                                    onclick="updateForm()">Update--}}
{{--                                            </button>--}}
                                            <button type="submit" class="btn btn-raised bg-red" onclick="cancelForm()">
                                                Cancel
                                            </button>
                                        </div>
                                    </div>
