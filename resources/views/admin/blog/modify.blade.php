			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="card">
						...
						<div class="body">
							<form method="post" action="{{route('blog.update',$blog_item->id)}}" id="blog_form_data" class="row clearfix">
								@csrf
								@method("PUT")
								...
								<div class="col-lg-3 col-sm-12">
									<div class="form-group">
										<div class="form-line">
											<input type="text" name="title" class="form-control" placeholder="Title" value="{{$blog_item->title}}" required>
										</div>
									</div>
								</div>
								<div class="col-lg-6 col-sm-12">
									<div class="form-group">
										<div class="form-line">
											<input type="text" name="description" class="form-control" placeholder="Description" value="{{$blog_item->short_description}}">
										</div>
									</div>
								</div>
								<div class="col-lg-3 col-sm-12">
									<div class="form-group">
										<div class="form-line">
											<input type="tags" name="tags" placeholder="Tags" value="{{$blog_tags}}">
										</div>
									</div>
								</div>
							</form>
							<div class="row clearfix">
									...
									<form action="{{route('blog.upload')}}" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
										...
										<div class="dz-message-container">
											<div class="dz-message">
												...
												<em>(When the thumbnail is not specified, the old image is used.)</em>
											</div>
										</div>
										<div class="fallback">
								...
								<div class="col-sm-12">
									<input class="form-check-input" id="cb_is_hidden" type="checkbox" name="hidden" form="blog_form_data" {{$blog_item->is_viewable?'':'checked'}}>
